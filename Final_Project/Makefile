...
all: sprint
sprint: USE.o Components.o Robot_part.o Model.o customer.o Sales_Associate.o shop.o Product_Manager.o PHB.o Order.o mainG.o login.o customer_menu.o pm_gui.o sa_gui.o
	$(CXX) $(CXXOPTS) $(FLTKFLAGS)$(LDFLAGS)  USE.o Robot_part.o Components.o Model.o customer.o Sales_Associate.o shop.o Product_Manager.o PHB.o Order.o mainG.o login.o customer_menu.o pm_gui.o sa_gui.o -o 'Mainnew' 'Mainnew.cpp' -Wl,-Bsymbolic-functions -lfltk_images -lfltk -lX11 
USE.o: USE.h USE.cpp
...
customer_menu.o: customer_menu.h 
	$(CXX) -c $(CXXOPTS) $(FLTKFLAGS)  customer_menu.cpp
pm_gui.o: pm_gui.h 
	$(CXX) -c $(CXXOPTS) $(FLTKFLAGS)  pm_gui.cpp
sa_gui.o: sa_gui.h 
	$(CXX) -c $(CXXOPTS) $(FLTKFLAGS)  sa_gui.cpp
run:
	./sprint.out
clean: 
